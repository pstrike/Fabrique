...
if ( 'both' === $image_action ) {
	...
	$action = $image_action;
	$popup = ( 'zoom' === $image_action ) ? false : true;
}
...
<div class="images fbq-product-gallery fbq-product-gallery--<?php echo esc_attr( $action ); ?> fbq-product-gallery--<?php echo esc_attr( $tn_position ); ?> fbq-gallery--carousel" data-popup="<?php echo esc_attr( $popup ); ?>" data-action="<?php echo esc_attr( $action ); ?>">

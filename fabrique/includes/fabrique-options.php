...
function fabrique_entry_options( $opts = array(), $post_id = '' )
{
	...
	if ( 'masonry' === $opts['layout'] && 'gradient' === $opts['style'] ) {
		...
		$opts['header_style']['margin'] = -$opts['spacing'] / 2 . 'px ' . -$opts['spacing'] / 2 . 'px ' . -$opts['spacing'] / 2 . 'px';
		$opts['header_style']['padding'] = $opts['spacing'] / 2 . 'px ' . $opts['spacing'] / 2 . 'px ' . $opts['spacing'] / 2 . 'px';
...
function fabrique_entry_instagram_options( $opts = array() )
{
	...
	$opts['media_attr'] = array(
		'class' => array( 'fbq-gallery-media' ),
		'style_attr' => array()
	);
	...
	if ( 'masonry' === $opts['style'] ) {
		...
		$opts['media_attr']['style_attr']['margin'] = -$opts['spacing'] / 2 . 'px ' . -$opts['spacing'] / 2 . 'px ' . -$opts['spacing'] / 2 . 'px';
		$opts['media_attr']['style_attr']['padding'] = $opts['spacing'] / 2 . 'px ' . $opts['spacing'] / 2 . 'px ' . $opts['spacing'] / 2 . 'px';
